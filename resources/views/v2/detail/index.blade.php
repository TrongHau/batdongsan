                                                            ...
                                                            <div id="property-section-facilities" class="property-section property-public-facilities">
                                                                ...
                                                                <div class="property-section-detail">
                                                                    <ul class="columns-gap">
                                                                        ...
                                                                        <li><span>Loại tin đăng:</span> {{$article->type_vip == ARTICLE_VIP_DIAMOND ? 'Tin Vip Kim Cương' : ($article->type_vip == ARTICLE_VIP_GOLD ? 'Tin Vip Vàng' : ($article->type_vip == ARTICLE_VIP_SILVER ? 'Tin Vip Bạc' : ($article->type_vip == ARTICLE_VIP_NORMAL ? 'Tin Vip Thường' : 'Tin Thường')))}}</li>
