                                                                ...
                                                                <div class="rowContentLeft">
                                                                    <div class="rowPost">
                                                                        ...
                                                                        <div class="leftArea leftPostArea">
                                                                            ...
                                                                            <div class="input">
                                                                                <input name="title" placeholder="Vui lòng nhập tiêu đề tin đăng của bạn. Tối thiểu là 30 ký tự và tối đa là 99 ký tự." value="{{old('title') ?? $article->title ?? ''}}" type="text" onchange="enableSmsOtp()" id="txtTitle" class="text-field has-help required countTypeLength form-control" maxlength="99" minlength="30">
                                                                    ...
                                                                    <div class="postrow padbt10">
                                                                        ...
                                                                        <div class="base4">
                                                                            ...
                                                                            <div id="divProductCate" class="comboboxs advance-select-box pad0">
                                                                                <select id="type_article" name="type_article" class="advance-options form-control" onchange="enableSmsOtp()" style="min-width: 220px;border: 1px solid #CCC;">
                                                                    ...
                                                                    <div class="postrow padbt10">
                                                                        ...
                                                                        <div class="base2">
                                                                            ...
                                                                            <div id="divCity" class="comboboxs advance-select-box pad0">
                                                                                <select id="select-province" name="province_id" class="advance-options select-province form-control" onchange="enableSmsOtp()" style="min-width: 220px;border: 1px solid #CCC;">
                                                                        ...
                                                                        <div class="base4">
                                                                            ...
                                                                            <div id="divDistrict" class="comboboxs advance-select-box pad0">
                                                                                <select name="district_id" class="advance-options select-district form-control" onchange="enableSmsOtp()" style="min-width: 220px;border: 1px solid #CCC;">
