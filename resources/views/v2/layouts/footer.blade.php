    ...
    <div class="container">
        <div class="footer-builder-wrapper lighting footer-1">
            <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-parallax="1.5"
                 data-vc-parallax-image="/wp-content/uploads/2017/06/bg-footer.jpg"
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-5 vc_col-md-4">
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper">
                                                    ...
                                                    <div class="information-footer">
                                                        <div class="media">
                                                            <div class="media-left media-middle">
                                                                <div class="icon"><i
                                                                            class="ion-ios-paperplane-outline text-second"><span
                                                        ...
                                                        <div class="media">
                                                            <div class="media-left media-middle">
                                                                <div class="icon"><i
                                                                            class="ion-ios-telephone-outline text-second"><span
                                                                                class="hidden">hidden</span></i></div>
                                                            </div>
                                                            <div class="media-body media-middle">0899 675 679</div>
                                                        </div>
                                                        <div class="media">
                                                            <div class="media-left media-middle">
                                                                <div class="icon"><i
                                                                            class="ion-ios-email-outline text-second"><span
                                                                                class="hidden">hidden</span></i></div>
                                                            </div>
                                            ...
                                            <div class="vc_empty_space  hidden-md hidden-lg" style="height: 32px"><span
                                                        class="vc_empty_space_inner"></span></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <ul id="menu-quick-link" class="menu">
                                                ...
                                                <li id="menu-item-2510"
                                                    ...
                                                    <a href="/nhung-cau-hoi-thuong-gap" >Những câu hỏi thường gặp</a></li>
                                                ...
                                                <div class="widget widget_nav_menu">
                                                    ...
                                                    <div class="menu-quick-link-container">
                                                        <ul id="menu-sub-link" class="menu">
                                                            <li id="menu-item-2507"
                                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2507">
                                                                <a href="/quy-dinh-dang-tin" >Quy định đăng tin</a></li>
                                                            <li id="menu-item-2508"
                                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2508">
                                                            ...
                                                            <li id="menu-item-2509"
                                                                ...
                                                                <a href="/dieu-khoan-thoa-thuan" >Điều khoản thỏa thuận</a></li>
                                                            <li id="menu-item-2510"
                                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2510">
                                                                <a href="/chinh-sach-bao-mat-thong-tin" >Chính sách bảo mật</a></li>
                                                            <li id="menu-item-2511"
                                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2511">
            ...
            <div data-vc-full-width="true" data-vc-full-width-init="true"
                ...
                <div class="wpb_column vc_column_container vc_col-sm-12">
                    <div class="vc_column-inner ">
                        <div class="wpb_wrapper">
                            <div style="font-size: 13px;color: #56ccf2;text-align: left;border-top: 1px solid #015fae66;padding-top: 10px;"
            ...
            <div id="login-register-register" class="tab-pane fade in">
                <div class="row no-margin visibled-table">
                    ...
                    <div class="visibled-cell no-padding col-sm-5 left-social">
                        <div class="social-connect">
                            <div class="desc">
                                Bạn có thể sử dụng đăng ký bằng facebook và google</div>
                            <ul class="login-social">
                                <li>
                                    <a class="btn btn-facebook btn-block" href="/auth/facebook">
                                        <i class="fa fa-facebook" aria-hidden="true"></i>
                                        Đăng ký qua Facebook</a>
                                </li>
                                <li>
                                    <a class="btn btn-google btn-block" href="/auth/google">
                                        <i class="fa fa-google" aria-hidden="true"></i>
...
@if(!Auth::check())
    <script>
        function resetInputLogin() {
            ...
            $('.login-register').find('.alert').remove();
            $('.login-register').find('.has-error').removeClass('has-error');
        }
        function addErrorInput(tag, content) {
            tag.parent().addClass('has-error');
            tag.before('<span class="help-block"><strong>' + content + '</strong></span>');
        }
        function authLogin() {
            resetInputLogin();
            const email = $('.login-form').find('.email');
            const password = $('.login-form').find('.password');
            if(!email.val()) {
            ...
            if(email.val().length < 4) {
                return addErrorInput(email, 'Địa chỉ E-Mail trên 4 ký tự.');
            }
            ...
            $.ajax({
                ...
                error: function (data) {
                    ...
                    $.each( errors.errors, function( key, value ) {
                        addErrorInput($('.login-form').find('.' + key), value);
                    });
                },
        ...
        function authRegister() {
            ...
            $.ajax({
                ...
                error: function (data) {
                    var errors = data.responseJSON;
                    $.each( errors.errors, function( key, value ) {
                        addErrorInput($('.register-form').find('.' + key), value);
                    });
                },
                success: function(response) {
                    window.location = '/thong-tin-ca-nhan';
