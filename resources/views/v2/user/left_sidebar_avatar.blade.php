                ...
                <div class="agent-small">
                    ...
                    <div class="box-arround">
                        <div class="useravatar">
                            ...
                            <label class="label_change_avatar" for="choose_user_avatar"><i class="material-icons"
                                                                                           style="font-size: 18px;">photo_camera</i>&nbsp
                                Thay đổi ảnh đại diện</label>
                            <input type="file" hidden class="form-control-file" name="choose_user_avatar"
                                   id="choose_user_avatar">
                            <input type="text" hidden class="form-control-file" name="avatar_data" id="avatar_data"
                                   value="">
                            ...
                            <div id="MainContent__userPage_pnlUserPoint" class="userpoint_menu">
                                ...
                                <div class="userpoint_menu_level">
                                    <label style="margin-bottom: 0px;">Tài khoản: {{$mySelf->UserType()->name}}</label>
                                </div>
                                <div class="userpoint_menu_point">
                                    <label style="font-size:18px; font-weight:bold;">{{number_format($mySelf->point_current)}}</label>
                                    <span style="font-size:16px; font-weight:normal;">&nbsp;điểm&nbsp;</span>
                                </div>
                            ...
                            <div class="userbalance">
                                ...
                                Tiền mặt:
                                <span id="MainContent__userPage_ltrBalance">{{number_format($mySelf->cash_curent)}}
                                    vnđ</span><br>
                                Tài khoản KM:
                                <span id="MainContent__userPage_ltrPromotion1">{{number_format($mySelf->cash_promotion)}}
                                    vnđ</span><br>
                            </div>
                        ...
                        <div class="title title_sidebar_left">Quản lý thông tin cá nhân</div>
                        <ul class="item">
                        ...
                        <div class="title title_sidebar_left">Quản lý tin rao</div>
                        <ul class="item">
                            <li class="row-content">
                                <a href="/thong-tin-ca-nhan" class="manage_article"
                            ...
                            <li id="MainContent__userPage_menuAdNewsManager" class="row-content">
                                <a href="/thong-tin-ca-nhan/quan-ly-mua-can-thue"
                            ...
                            <li id="MainContent__userPage_menuPostAdNews" class="row-content">
                                <a href="/quan-ly-tin/dang-tin-can-mua-can-thue" title="Đăng tin rao cần mua/cần thuê">Đăng
