		  ...
		  <div class="box">
            ...
            <div class="box-footer">
				<div id="saveActions" class="form-group">
					...
					<a href="/quan-ly-tin/dang-tin-ban-cho-thue/{{$fields['id']['value']}}" target="_blank" class="btn btn-warning"><span class="fa fa-align-center"></span> &nbsp;Chỉnh sửa trực tiếp</a>
					<a href="/admin/article_lease_up/{{$fields['id']['value']}}" class="btn btn-primary"><span class="fa fa fa-upload"></span> &nbsp;Up tin tức</a>
					<div class="btn-group">
