                        ...
                        <div class="box-body row display-flex-wrap" style="display: flex; flex-wrap: wrap;">
                            ...
                            <div class="form-group col-xs-4">
                                ...
                                <select name="type_article" class="form-control">
                                    <option value="Bán căn hộ chung cư">Căn hộ/Chung cư</option>
                                    <option value="Bán nhà riêng">Nhà ở</option>
                                    <option value="Bán đất">Đất</option>
                                    <option value="Bán loại bất động sản khác">Văn phòng, Mặt bằng kinh doanh</option>
                                </select>
                            </div>
