                ...
                <div class="box">
                    ...
                    <div class="box-footer">
                        <div id="saveActions" class="form-group">
                            ...
                            <a href="/admin/sync_article_for_buy/approval/{{$fields['id']['value']}}" class="btn btn-warning" style="background-color: #000000; border-color: #171615;"><span class="fa fa-check-square-o"></span> &nbsp;Duyệt tin này</a>
                            <div class="btn-group">
