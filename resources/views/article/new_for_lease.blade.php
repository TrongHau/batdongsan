                                    ...
                                    <div class="rowContent">
                                        <div class="rowContentLeft">
                                            ...
                                            <div class="postrow padbt10">
                                                ...
                                                <div class="base4">
                                                    <div style="float: left;">
                                                        <input name="area" type="number" step=".01" value="{{old('area') ?? $article->area ?? ''}}" id="area" class="text-field" max="999" style="width: 110px;">
                                                        @if ($errors->has('area'))
                                            ...
                                            <div class="postrow padbt10">
                                                ...
                                                <div class="base2">
                                                    <input name="price" style="width: 215px;" step=".01" type="number" id="price" value="{{old('price') ?? $article->price ?? ''}}" class="text-field" numberonly="2" maxlength="6">
                                                    @if ($errors->has('price'))
                                            ...
                                            <div class="postrow">
                                                ...
                                                <div class="base5">
                                                    ...
                                                    @if ($errors->has('contact_name'))
                                                        <div class="errorMessage" style="display: block;"><p style="color: red">{{ str_replace('contact_name', 'tên liên hệ', $errors->first('contact_name'))}}</p></div>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="postrow">
                                                ...
                                                <div class="base5">
                                                    ...
                                                    @if ($errors->has('contact_address'))
                                                        <div class="errorMessage" style="display: block;"><p style="color: red">{{ str_replace('contact_address', 'địa chỉ', $errors->first('contact_address'))}}</p></div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="postrow">
                                                ...
                                                <div class="base5" style="position: relative;">
                                                    <div id="divBrMobile" class="comboboxs advance-select-box" style="margin: 0px;height: 25px;position: relative;">
                                                        <input type="text" name="contact_phone" class="select-text-content required" value="{{old('contact_phone') ?? $article->contact_phone ?? $mySelf->phone}}" placeholder="" style="width: 175px;">
                                                        @if ($errors->has('contact_phone'))
                                                            <div class="errorMessage" style="display: block;"><p style="color: red">{{ str_replace('contact_phone', 'di động', $errors->first('contact_phone'))}}</p></div>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="base51">
                                                        ...
                                                        @if ($errors->has('contact_email'))
                                                            <div class="errorMessage" style="display: block;"><p style="color: red">{{ str_replace('contact_email', 'email', $errors->first('contact_email')) }}</p></div>
                                                        @endif
                                                    </div>
                                                </div>
