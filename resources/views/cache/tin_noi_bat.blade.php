...
$noibat = array (
  ...
  array (
    ...
    'short_content' => 'Thời gian gần đây, không ít khách hàng lâm vào cảnh "tiền mất tật mang" do gặp phải các vấn đề như: Chậm bàn giao nhà, bán một căn hộ cho nhiều người... khi mua nhà hình thành trong tương lai.
Theo Luật sư Trần Đức Phượng, Đoàn Luật sư Tp.HCM, trong quá trình vận hành của nền kinh tế sẽ luôn có hai mặt, cơ hội đầu tư và rủi ro luôn cùng đồng hành, song rất khó nhận diện rõ về hai điểm này.',
  ...
  array (
    ...
    'short_content' => 'Nhân dịp kỷ niệm 12 năm thành lập Tập đoàn, Batdongsan.com.vn sẽ tổ chức các hoạt động đặc biệt dành cho cán bộ nhân viên từ ngày 6/1 đến hết ngày 9/1/2019.
Ngoài các sự kiện tri ân khách hàng đã tổ chức trước đó, đầu tháng 1/2019, Batdongsan.com.vn cũng sẽ tổ chức các hoạt động đào tạo kết hợp du lịch, nghỉ ngơi dành cho cán bộ nhân viên. Vì vậy, chúng tôi xin thông báo lịch nghỉ của công ty tới Quý khách hàng như sau:',
    'slug_category' => 'chinh-sach-quan-ly',
    'category_parent_id' => NULL,
  ),
  3 => 
  ...
  array (
    ...
    'views' => 0,
    'image' => 'uploads/tin-tuc/20181218094703-6c96.jpg',
    'short_content' => 'Vì để nhà cửa quá bừa bộn, đồ đạc ngổn ngang, sàn tường lem luốc nên suốt gần một năm, anh Nguyên (Tp.HCM) không bán được căn hộ.',
    'slug_category' => 'chinh-sach-quan-ly',
    'category_parent_id' => NULL,
  ),
  5 => 
...
Năm 2013, anh Quyết mua được một miếng đất diện tích khoảng 600 m2 nằm tại xã Phước Lộc, huyện Nhà Bè. Khu đất này đã có 250 m2 đất lên thổ cư. Đến năm 2016, anh quyết tâm xây một ngôi nhà thật rộng rãi để đón cả nhà về ở vì đã chán cảnh chật chội trong căn nhà cấp 4 chỉ rộng 35 m2 mà có tới 5 thành viên, 3 thế hệ chung sống ở quận 7.',
  ...
  array (
    ...
    'views' => 0,
    'image' => 'uploads/tin-tuc/20190104162011-2c1e.jpg',
    'short_content' => 'Tài sản chung của vợ chồng gồm tài sản do vợ, chồng tạo ra, thu nhập do lao động, hoạt động sản xuất, kinh doanh, hoa lợi, lợi tức phát sinh từ tài sản riêng và thu nhập hợp pháp khác trong thời kỳ hôn nhân, trừ trường hợp được quy định tại khoản 1 Điều 40 của Luật này; tài sản mà vợ chồng được thừa kế chung hoặc được tặng cho chung và tài sản khác mà vợ chồng thỏa thuận là tài sản chung.',
    'slug_category' => 'chinh-sach-quan-ly',
    'category_parent_id' => NULL,
  ),
  7 => 
  ...
  array (
    ...
    'short_content' => 'Hỏi: Tại Khoản 11, Điều 9 Thông tư 24/2014/TT-BTNMT ngày 19/5/2014 của Bộ Tài nguyên và Môi trường có quy định về hồ sơ nộp khi thực hiện thủ tục tách thửa hoặc hợp thửa đất gồm: Đơn đề nghị tách thửa hoặc hợp thửa theo Mẫu số 11/ĐK; bản gốc Giấy chứng nhận đã cấp.',
    'slug_category' => 'chinh-sach-quan-ly',
    'category_parent_id' => NULL,
  ),
  9 => 
