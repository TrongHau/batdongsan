...
//        $Content = "Mã xác thực số điện thoại của bạn tại Batdongsan.company là: 123456";
        ...
        $data = "http://rest.esms.vn/MainService.svc/json/SendMultipleMessage_V4_get?Phone=$YourPhone&ApiKey=$APIKey&SecretKey=$SecretKey&Content=$SendContent&Brandname=0901800070&SmsType=" . env('SMS_TYPE');
