...
class ArticleForBuyModel extends Model
{
    ...
    'method_article_url', 'type_article_url', 'province_url', 'district_url', 'ward_url', 'street_url', 'price_real', 'project', 'featured', 'type_vip', 'expired_vip', 'created_time_vip', 'disabled_vip'];
